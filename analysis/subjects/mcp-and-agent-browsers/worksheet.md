...
7. leftover27 unused `docs.obscura.sh/llms.txt` **2,687 B** lists **21** doc links + GitBook `?ask=` ([obscura](../../tools/obscura.md); [github-h4ckf0r0day-obscura#c7](../../items/github-h4ckf0r0day-obscura/card.md)). Did not run the ask endpoint. leftover24 Star **16.2k** / **<50ms** / **10×** still need a headed timing, not another HTML page.
8. leftover28 unused `aimock.copilotkit.dev` **135,659 B** (`npx @copilotkit/aimock`; docker **4010**) ([copilotkit-aimock](../../tools/copilotkit-aimock.md)). leftover28 unused Browser Run overview **138,466 B** names REST actions + WebMCP Beta — still no live session ([kitesurf](../../tools/kitesurf.md); [web-cloudflare-kitesurf#c4](../../items/web-cloudflare-kitesurf/card.md)).
9. leftover29 unused `punkpeye/awesome-mcp-servers` MIT **94,179★**; Glama **244,196 B** / **81,811** servers; MCP intro spec **2026-07-28** ([kitesurf](../../tools/kitesurf.md); [github-punkpeye-awesome-mcp-servers#c3](../../items/github-punkpeye-awesome-mcp-servers/card.md)). Did not install a listed server.
10. leftover30 unused `punkpeye/awesome-mcp-clients` MIT **6,577★** ([kitesurf](../../tools/kitesurf.md); [github-punkpeye-awesome-mcp-servers#c4](../../items/github-punkpeye-awesome-mcp-servers/card.md)). leftover30 unused `superdesigndev/treg` leftover24 **1,190★** ([treg](../../tools/treg.md)). leftover30 unused Obscura GitHub / docs leftover24/27 ([obscura](../../tools/obscura.md)).
