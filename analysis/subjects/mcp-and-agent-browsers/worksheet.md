...
2. Obscura 0.2.1 boot: example.com PNG 17,130 B / 1280×720; idle serve RSS ~25 MB; CDP `/json/version` Chrome/145 — [obscura](../../tools/obscura.md). Remaining: RSS with a page loaded (not idle).
