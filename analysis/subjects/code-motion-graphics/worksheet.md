...
6. Remotion homepage + GitHub are first-party ([remotion](../../tools/remotion.md)): **58,331★** / license NOASSERTION; Creators **$25/mo/seat**; Automators **$0.01/render** / **$100/mo** min ([x-2086030681772376399#c2](../../items/x-2086030681772376399/card.md)). leftover14 imperfect-video leftover names no renderer — same Remotion attach, do not collapse ([x-2091622751756751211#c2](../../items/x-2091622751756751211/card.md)).
...
10. leftover27 unused `animos.app` **2,864 B** titles *animos — Motion templates*; visible extract empty ([animos-editor](../../tools/animos-editor.md); [web-animos-editor#c3](../../items/web-animos-editor/card.md)). Remaining: open the editor / export a template.
11. leftover28 unused `lottiefiles.com` **403 / 5,598 B** Cloudflare — do not hammer ([remotion](../../tools/remotion.md); [web-lottiefiles#c3](../../items/web-lottiefiles/card.md)).
12. leftover29 unused GitHub `nexu-io/motion-anything` Apache-2.0 **756★** ([motion-anything](../../tools/motion-anything.md); [github-nexu-io-motion-anything#c4](../../items/github-nexu-io-motion-anything/card.md)). leftover29 does not run a motion compile.
13. leftover30 unused GitHub `nexu-io/open-design` Apache-2.0 **94,132★** (was **94,085★**) on the html-video READY card ([open-design](../../tools/open-design.md); [github-nexu-io-html-video#c5](../../items/github-nexu-io-html-video/card.md)).
