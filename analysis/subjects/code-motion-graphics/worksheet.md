...
1. **HTML/CSS as the timeline, local MP4 out.** [nexu-io/html-video](../../items/github-nexu-io-html-video/card.md) (Hyperframes + ffmpeg; 14 agents / 21 templates stated). HeyGen launch clip is the public example ([x-2093129469926215800](../../items/x-2093129469926215800/card.md)).
2. **Chat-native recipes with Lottie/MP4 export.** [motion-anything](../../items/github-nexu-io-motion-anything/card.md) (403 recipes, eight engines stated). video-shotcraft is Remotion + 152 shot cards ([x-2095204640690147487](../../items/x-2095204640690147487/card.md)).
...
|---|---|---|---|---|---|
| html-video / HyperFrames | high | HTML → Chromium → MP4 | 21 templates stated | high (14 agents stated) | optional (you already have frames) |
| motion-anything | high | live page + Lottie/MP4 | 403 recipes stated | high (8 engines) | export, then maybe |
| video-shotcraft | high | Remotion | 152 cards stated | high (Claude Code) | n/a |
...
1. Render one html-video template locally; attach the MP4 path on the card.
2. Count motion-anything recipes and video-shotcraft cards from the repos, not the tweets.
3. If the HeyGen thread promised source, extract it into `thread-raw/` if it is still missing.
