...
1. leftover21: `skill-v4.1.0` release JSON (2026-08-14) is now on `#c7`. leftover19 homepage **109,943 B** still does not name tags (`#c6`). Do not collapse 4.1.0 notes with **4.2.0** (`#c5`).
2. leftover19: `styles.refero.design` still markets **2,000+** (`#c5`). API re-count stays **1,289 / 1,241**. Records are JSON blobs, not DESIGN.md ([styles-refero-design](../../tools/styles-refero-design.md)). Remaining: a keyed Hyperbrowser extract.
...
8. leftover22 unused first-party: creatoreconomy human-review essay **207,273 B** ([human-review](../../tools/human-review.md)); how-to-ai.guide → Ruben Substack **925,000** subscribers ([claude-skills-free](../../tools/claude-skills-free.md)); t.co NameThatUI → Toolfolio listing **408,882 B** ([name-that-ui](../../tools/name-that-ui.md)); `google-labs-code/design.md` **27,737★** ([getdesign-md](../../tools/getdesign-md.md)). designmd.supply stays 429.
9. leftover24 unused `design-md.hyperbrowser.ai` **5,659 B** is a “Booting DESIGNMD” SPA — not a catalog ([getdesign-md](../../tools/getdesign-md.md); [x-2095078647652917329#c4](../../items/x-2095078647652917329/card.md)). leftover24 unused AIDesigner MCP endpoint still **401 / 40 B** ([aidesigner-mcp](../../tools/aidesigner-mcp.md); [x-2094467179320119498#c4](../../items/x-2094467179320119498/card.md)).
10. leftover25 unused `http://styles.refero.design` resolves to the **103,024 B** https homepage still marketing **2,000+**; API stays **1,289 / 1,241** ([styles-refero-design](../../tools/styles-refero-design.md); [x-2091934379648110784#c3](../../items/x-2091934379648110784/card.md)).
11. leftover27 unused READY-card leftovers: Stitch spec **25,497 B** empty SPA ([getdesign-md](../../tools/getdesign-md.md); [github-google-labs-code-design-md#c4](../../items/github-google-labs-code-design-md/card.md)); impeccable.style **109,943 B** restates leftover19 4.1 **66k / 61 / 23 / 177** and GitHub **4.2.0** **5,961 B** restates leftover05 — do not collapse ([impeccable](../../tools/impeccable.md); [github-pbakaus-impeccable#c8](../../items/github-pbakaus-impeccable/card.md) / `#c9`); tasteskill.dev **v2** / **13** skills / **16** sponsors ([taste-skill](../../tools/taste-skill.md)); Emil `skills.sh` **12** / **1.2M** plus thin `animations.dev/skills`; ui-skills.com is other authors, not MengTo ([mengto-skills](../../tools/mengto-skills.md)); jakub.kr/skills names the better-* set ([better-interface](../../tools/better-interface.md)). Remaining: a shared-fixture score, not another catalog page.
