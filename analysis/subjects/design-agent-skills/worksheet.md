...
4. Re-fetch `x-2093669411685110141` and the blocked designmd.me / designmd.supply hosts. Neighbor **designmd.app** is live with marketing **562** files — not getdesign.md’s 550+ / sitemap 627 ([getdesign-md](../../tools/getdesign-md.md)).
