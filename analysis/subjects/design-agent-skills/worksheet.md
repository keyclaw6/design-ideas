...
1. leftover19: `impeccable.style` **109,943 B** markets **61 / 23 / 177** and `npx impeccable install` — homepage does not name 4.1 vs 4.2.0 (`#c6`). Detector receipts stay on [impeccable](../../tools/impeccable.md). Remaining: do not treat 4.2.0 as the 4.1 install notes.
