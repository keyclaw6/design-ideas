...
1. 61-id list + desktop URL detects + **mobile 390x844** (fixture 20 / blume 85 / frontal 138) are on [impeccable](../../tools/impeccable.md). nateherk.com and complete-shelf live detect **timed out** at 30 s (`[]`, exit 0). Remaining: do not treat 4.2.0 as the 4.1 card.
