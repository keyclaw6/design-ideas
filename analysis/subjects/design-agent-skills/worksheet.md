...
2. Refero public API re-count 2026-09-05 is still **1,289** ids / **1,241** siteNames (now claimed on the must-read card `#c4`). Linear / Notion / Stripe records stay JSON `designSystem` blobs, not DESIGN.md ([styles-refero-design](../../tools/styles-refero-design.md)). Remaining: a keyed Hyperbrowser extract of the same two URLs.
