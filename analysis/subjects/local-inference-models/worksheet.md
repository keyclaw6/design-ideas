...
4. Bonsai-1.7B leftover now has first-party HF `prism-ml/Bonsai-1.7B-gguf` Apache-2.0 (**91** likes / **66,378** dl; Q1_0 **0.24 GB**; 4090 **674 vs 224** / M4 Pro **250 vs 65**). Tweet **64→90** Android CPU and “3× llama.cpp” are **not** on the README or prismml.com (**96,797 B**; hero is Bonsai **27B**). Do not collapse ([x-2087962842985058365#c3](../../items/x-2087962842985058365/card.md)). Qwen expert-on-disk **37 GB** is not REAP-288 **39/68** ([x-2093429897188299113#c3](../../items/x-2093429897188299113/card.md)).
