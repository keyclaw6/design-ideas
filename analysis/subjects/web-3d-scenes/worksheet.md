...
14. leftover29 unused READY-card leftovers: `oso95/scroll-world` MIT **8,996★** plus `monid.ai` **91,135 B** / **1,700+** and `higgsfield.ai` **530,407 B** (drift vs leftover9 **530,348 B**) ([scroll-world-skill](../../tools/scroll-world-skill.md); [monidhq](../../tools/monidhq.md); [github-oso95-scroll-world#c3](../../items/github-oso95-scroll-world/card.md)); `scottstts/Threejs-Awesome-Graphics-Agent-Skills` MIT **782★** ([threejs-awesome-graphics-agent-skills](../../tools/threejs-awesome-graphics-agent-skills.md); [github-scottstts-threejs-awesome-graphics-agent-skills#c5](../../items/github-scottstts-threejs-awesome-graphics-agent-skills/card.md)); `mortspace/feral-blob` MIT **17★** ([feralui](../../tools/feralui.md); [web-feralui-dev#c4](../../items/web-feralui-dev/card.md)). Remaining: an account export / package install, not another homepage.
