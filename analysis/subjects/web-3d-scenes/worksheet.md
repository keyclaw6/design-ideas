...
6. Meng To “40-min” Three.js + Claude Code tutorial is the X amplify video on `MengTo/2088117711868227765` (**2411.133 s**, 2880×2160) — no separate docs/YouTube ([mengto-skills](../../tools/mengto-skills.md)). Pointer card stays `ready-with-gaps` because the thread is `empty`.
