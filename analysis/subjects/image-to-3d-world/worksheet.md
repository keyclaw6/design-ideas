...
3. kokraf README is a VEF modeler, not a four-view bake skill ([kokraf](../../tools/kokraf.md)). Projection path is still tweet/media-only — now a counter-claim on [x-2057113327508345047#c3](../../items/x-2057113327508345047/card.md).
4. Lucida card is now `ready`. Remaining world-gen primaries are mostly `ready-with-gaps` on thread-partial. Raising even two more world-gen cards to `ready` still needs a downloadable user scene (WorldGen / Marble), not another JP tweet gloss. hayashimon panorama card dropped `translation-needed`; 3 person-days stays tweet-only.
5. Needle Mesh Baker is named on needle.tools (**108,738 B**). Tweet **3.2M → 3K / 3 s** stays tweet-only ([x-2091927587471712274#c3](../../items/x-2091927587471712274/card.md)).
6. Photo→Blender leftover is not the cafe Blender MCP article ([x-2095512142766342624#c2](../../items/x-2095512142766342624/card.md)). Still a one-liner.
7. leftover22 unused Spark pages: sparkjs.dev **19,204 B**; Spark 2.0 blog **770,998 B** (6M / 100M+ / 40M / 500K–2.5M); xrarchitect.xyz **2,689 B** empty portfolio ([spark-js](../../tools/spark-js.md); [x-2094864872853119216#c4](../../items/x-2094864872853119216/card.md)). Still no user WorldGen export.
8. leftover28 unused `seed.bytedance.com/en/seed3d_2_0` **136,088 B** is the Seed hub (Seedance 2.5 / Seedream 5.0 Pro). Visible extract does **not** name Seed3D 2.0 or Lucida ([image-to-3d-worldgen](../../techniques/image-to-3d-worldgen.md); [x-2094961942058418268#c5](../../items/x-2094961942058418268/card.md)). Still no user export.
