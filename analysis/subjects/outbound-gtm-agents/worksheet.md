...
3. Vacca `linked-page-unfetched` cleared — frontal.so + three case studies + GTM blog are on [clay](../../tools/clay.md). `/blog` index **52,962 B** still has no 3× / 1,000 / 5–11% (card `#c4`). Thread stays `captured_partial`. Remaining: a property + date window for those tweet claims. MapsData/Instantly 10k/day stays capacity math.
