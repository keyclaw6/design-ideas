...
1. leftover20: mem0 / Letta / Zep / Graphiti / Gorgias first-party pages do **not** carry the tweet 12,000 or the nine-name map (`#c7`). Ebook PDF still gated. ReasoningBank live repo now **562★** (prior 561); guessed Google blog URLs **404** (`#c5`). Remaining: a company-prod extract (Slack/CRM) or the gated PDF — not more vendor homepages.
