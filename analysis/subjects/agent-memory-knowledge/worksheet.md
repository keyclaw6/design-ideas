...
9. leftover23 unused abs `arxiv.org/abs/2604.21284` **43,643 B** is a **MemPalace critique** (Dey/Viradecha), not a gbrain paper. MemPalace **47,000★** / claimed LongMemEval **96.6% Recall@5** attributed to verbatim + ChromaDB `all-MiniLM-L6-v2`. Do not collapse 96.6% with tweet **97.6%** or official gbrain-evals **93.19%/95.32%** ([gbrain-evals](../../tools/gbrain-evals.md); [x-2094462971598754010#c6](../../items/x-2094462971598754010/card.md)). Do not invent `mempalace.md`.
10. leftover24 unused ReasoningBank abs `arxiv.org/abs/2509.25140` **45,267 B** is still ICLR 2026 v2 (16 Mar 2026). Tables already on [reasoning-bank](../../tools/reasoning-bank.md). OpenReview still gated ([x-2087143369181114868#c6](../../items/x-2087143369181114868/card.md)).
11. leftover29 unused neighbor essays now on READY cards: Gasquez **13,726 B** + Context.ai filesystem **38,717 B** ([web-davidgasquez-context-engineering#c5](../../items/web-davidgasquez-context-engineering/card.md)); Macomber **67,426 B** + Rill **88,734 B / 3k** ([web-iandmacomber-post-ai-data-stack#c4](../../items/web-iandmacomber-post-ai-data-stack/card.md)); Anthropic Claude Tag Slack **517,319 B** ([web-anthropic-claude-self-service-data#c3](../../items/web-anthropic-claude-self-service-data/card.md)). leftover29 unused `pipeshub-ai/pipeshub-ai` Apache-2.0 **3,724★** ([pipeshub](../../tools/pipeshub.md); [x-2088623462109593792#c2](../../items/x-2088623462109593792/card.md)). Park essays on [reasoning-bank](../../tools/reasoning-bank.md). Did not run a connector or a Slack Tag session.
12. leftover30 unused leftover29 neighbor essays now recorded as unused-host skips on the sibling READY cards. leftover15 Anthropic self-service URL stays leftover15, not leftover29 Slack ([reasoning-bank](../../tools/reasoning-bank.md)).
