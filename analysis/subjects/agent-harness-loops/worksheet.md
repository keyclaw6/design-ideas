...
- Pocock `/improve-codebase-architecture` is first-party on aihero.dev **368,578 B**: survey HTML report, **no code change**. Repo `mattpocock/skills` MIT **250,588★** this pass ([x-2086838432102228008#c2](../../items/x-2086838432102228008/card.md)).
