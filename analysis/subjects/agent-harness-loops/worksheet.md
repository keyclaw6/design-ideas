...
3. Chadha primer host `autoresearch.aman.ai` still times out; `aman.ai/autoresearch` is **404** ([autoresearch-loop](../../techniques/autoresearch-loop.md)). Keep fini’s shared-profile warning next to any “six Grok bots” outbound pitch.
