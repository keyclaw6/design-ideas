...
- [Stanford Control Plane Pattern: replace brittle multi-agent handoff chains](../../items/x-2087254502210490739/card.md) — reference, technique — Thread summary of a Stanford AI Systems Lab paper arguing multi-agent pipelines rot context at each handoff and proposing a Control…
