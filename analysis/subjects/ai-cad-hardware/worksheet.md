...
7. Fable 5.1 W16 leftover has no matching CAD host: `fable.ai` is a Spaceship listing at **$1,500,000**; `fable.com` **403**; GH `fable 5.1 cad` **0**. Neighbor text-to-cad `covers.step` is not a Fable export ([fable-cad](../../tools/fable-cad.md); [x-2095352925597884465#c2](../../items/x-2095352925597884465/card.md)).
8. Fusion-as-database leftover now points at official MCP (4 raw-Python tools) vs wrapper **75/74** ([autodesk-fusion](../../tools/autodesk-fusion.md); [x-2088296314484162719#c3](../../items/x-2088296314484162719/card.md)). Fastener-search session still has no STEP.
9. Smith leftover first-party is Arche Industries **122,718 B** (Python source of truth; DFM 20 orientations; Scrapyard “Jet plane, display model” is not the tweet mini jet). `smith.ai` is receptionists — do not collapse ([x-2089802212000362939#c2](../../items/x-2089802212000362939/card.md)). Sipeed wiki **72,489 B** is MaixCAM/FPGA docs; one-hour schematic stays tweet-only ([x-2092106682302140648#c2](../../items/x-2092106682302140648/card.md)).
10. leftover14 OpenSCAD first-party: `openscad.org` **8,719 B**; `openscad/openscad` **10,133★** NOASSERTION. grill-me reply is the official **157 B** alias. Neighbor `nurb.dev` **29,103 B** / `Shpigford/nurb` **501★** is talk-to-print, not the OpenSCAD rack. Printable-rack claim stays tweet-only ([x-2088252062454751483#c2](../../items/x-2088252062454751483/card.md)).
11. leftover28 unused `cadxstudio.in` **3,111 B** is a thin AI Design Engine shell on both CadX leftovers ([cadx-studio](../../tools/cadx-studio.md)). Still no STEP export.
