...
- Mint Studio “browser 3D camera for video” — thread failed. “Live now here!” `t.co/kfmFB5sFWU` → **mint.gg**. leftover19 remaining t.co (render / city / World Labs) loop to X. Still no camera-path exporter ([mint-studio](../../tools/mint-studio.md) `#c5`).
...
12. GLM kitchen leftover now has official docs ([glm-5-3-flash](../../tools/glm-5-3-flash.md); [x-2093047548550525165#c3](../../items/x-2093047548550525165/card.md)): **320B / 18B**, **1M / 128K**, Blender 3D scene recipe, HF MIT **2,053** likes / **654,957** dl, arXiv **2602.15763**. Kitchen-specific copy stays tweet-only. Codex desk clip is bpy, not blender-mcp ([x-2065843739340509693#c2](../../items/x-2065843739340509693/card.md)).
13. Higgsfield MCP gray-box leftover now points at the leftover9 homepage **530,348 B** + 72,653 B blog ([x-2093663876692754713#c2](../../items/x-2093663876692754713/card.md)). Playblast → Seedance recipe stays tweet-only.
14. leftover22 unused `tapirconvert.com/video-upscaler` **403 / 5,513 B** Cloudflare — do not hammer. Prior tapir.gg **1,459 B** empty is a different host ([x-2093986548404428942#c4](../../items/x-2093986548404428942/card.md)).
15. leftover28 unused MiniMax H3 create-video docs **442,375 B** plus HF **4,913** likes / **5,118,457** dl ([minimax-h3](../../tools/minimax-h3.md); [note-blender-minimax-h3-video-generation#c4](../../items/note-blender-minimax-h3-video-generation/card.md)). Did not submit a create-task call.
16. leftover29 unused note.com Ponyo Blender timelapse **316,890 B** — Geometry Nodes / crayon look; not an H3 blockout recipe ([minimax-h3](../../tools/minimax-h3.md); [x-2093256024635666465#c2](../../items/x-2093256024635666465/card.md)).
17. leftover30 unused MiniMax create-video docs host string is leftover28 `#c4` ([minimax-h3](../../tools/minimax-h3.md); [note-blender-minimax-h3-video-generation#c5](../../items/note-blender-minimax-h3-video-generation/card.md)).
