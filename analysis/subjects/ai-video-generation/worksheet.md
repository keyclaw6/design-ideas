...
4. fujiryu00 “H3 is free” video is **13.723 s** / 1108×720. Hailuo homepage **848,994 B** says H3 is live with **From /mo** + Sign In; page “Free” is an image-pack category. Pricing page **617,559 B** names Standard **$14.99/mo** / Pro **$54.99/mo** (card `#c4`). Research blog `/blog/minimax-h3` **98,310 B** (15 s @ 2K; weights planned). Tweet 無料 stays tweet-only ([minimax-h3](../../tools/minimax-h3.md)).
