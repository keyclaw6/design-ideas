...
- Originkit homepage RSC **468 unique** `…/components/<slug>-gallery` slugs. Card “363+” is marketing; 363 in the dump was a font hash. MCP hello JSON: **4** tools, **`components`: 461**; `/v1/registry` count **461**. Public site `/registry.json` 404. Do not collapse 461 with 468. `/pricing` plan JSON: Free $0/year 3/2/1 daily C/S/T; Pro $79/year (compare-at $108) 10/5/3; Studio $179/year (compare-at $228) 25/10/5. Do not collapse with the integrations-page beta quota. CSS bundle **201,892** B / **21** `@media` (max-width 1023 + min-width 640–1920). `originkit.com` **503**.
...
- Pre-launch teasers and “polish beats paid attention” clips — mood, not a kit. leftover18: leftover13 t.co loops to X; Motionsites **56,054 B** has no 590; Originkit is a kit, not the polish clip; related Nate Herk is Fable 5.1 + scroll-craft (article **9,821** chars) — do not collapse ([x-2093364419044794836#c2](../../items/x-2093364419044794836/card.md), [x-2093024468209733756#c2](../../items/x-2093024468209733756/card.md), [x-2095429087141515616](../../items/x-2095429087141515616/card.md)).
...
4. leftover19: Parallax layer-separation t.co → `remove.bg` **60,038 B** — generic bg-remove, not a custom tool ([x-2093915384944414827#c3](../../items/x-2093915384944414827/card.md)). Nate Herk X article **2094971964163006468** body is on [fable-5-1](../../tools/fable-5-1.md) (9,821 chars; four cost pairs). scroll-craft stays in the tweet replies. Root video **533.524 s** / 1920×1080; thread stays `failed`. Inertial carousel [x-2089223944700326052](../../items/x-2089223944700326052/card.md) is now `ready`.
...
6. DesignByMoein leftover has no public DESIGN.md host: `designbymoein.com` NXDOMAIN. `moeindesign.com` is a different Moein blog (**378,216 B**, lorem contact) — do not collapse ([cursor](../../tools/cursor.md); [x-2095207624396652956#c2](../../items/x-2095207624396652956/card.md)). Same attach on the Hogwarts event leftover ([x-2093767075131220005#c2](../../items/x-2093767075131220005/card.md)) and leftover13 SaaS-direction leftover ([x-2090079734571098131#c2](../../items/x-2090079734571098131/card.md)).
7. leftover13 designertom “what’s possible” quoted t.co is **pear.no** (**53,685 B**), PEAR AS revenue-share SEO/software partnership — not a motion skill ([x-2091616414063022208#c2](../../items/x-2091616414063022208/card.md)).
8. leftover22 unused `outbid.lol` **429 / 32,182 B** — do not hammer ([x-2093774183356379560#c4](../../items/x-2093774183356379560/card.md)). leftover22 unused `store.brasshands.com` **351,750 B** is merch, not the terrain-intel mock ([motionsites-ai](../../tools/motionsites-ai.md)).
9. leftover23 unused `dicebear.com` **127,824 B**: **61** styles / **9.5k** / MIT / **1B** API req/mo — park on [blume](../../tools/blume.md); do not invent `dicebear.md` ([x-2094524951025914278#c6](../../items/x-2094524951025914278/card.md)). leftover23 unused kit leftovers: `component.gallery` **100,837 B** (60 / **95** / 2,671 — tweet 95 matches); `orbs.jakubantalik.com` **9,375 B** moved to libraries.dev; `transitions.dev` **657,428 B**; `21st.dev` **188,741 B** markets **12,000+** / **2** free copies/day; `ui.aceternity.com` **768,064 B**. Park on [agentation](../../tools/agentation.md). Do not invent `21st.md` / `aceternity.md` ([x-2089263766428950683#c4](../../items/x-2089263766428950683/card.md)).
