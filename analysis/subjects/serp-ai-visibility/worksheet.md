...
12. leftover25 unused Crunchbase **128,439 B**; G2 **403** and Product Hunt **403** — do not hammer. No DR 11→46 ([tinyshelf](../../tools/tinyshelf.md); [x-2094684433546985907#c5](../../items/x-2094684433546985907/card.md)).
13. leftover26 unused `mcp.crowdreply.io/mcp` stays keyed; unused `iannuttall/seo` host string is leftover24 `#c6`. Do not hammer.
14. leftover28 unused READY-card leftovers: nqz generator **36,810 B** restates leftover22 plus `/free-ai-tools` **28,162 B** (**6** pillars / **10**/hour / **30**/day) ([nqz-ai-search-prompt-generator](../../tools/nqz-ai-search-prompt-generator.md); [web-nqz-ai-search-prompt-generator#c3](../../items/web-nqz-ai-search-prompt-generator/card.md)); known.agency **965,519 B** leftover18 vendor copy now on the READY card — do not invent `known-agency.md` ([tinyshelf](../../tools/tinyshelf.md)); TinyLaunch directories **106,620 B** leftover22 **691** / **$279** now on the READY card ([tinyshots](../../tools/tinyshots.md)). DR 11→46 still tweet-only.
15. leftover30 unused `iannuttall/seo` leftover24 leftover now on the READY card ([seo-skill-cli](../../tools/seo-skill-cli.md); [github-iannuttall-seo#c3](../../items/github-iannuttall-seo/card.md)). leftover30 unused seowins YouTube leftover — do not hammer ([seoskill-dev](../../tools/seoskill-dev.md)).
