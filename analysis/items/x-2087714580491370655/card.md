...
- `x-2087714580491370655#c4` (recipe, demonstrated) leftover22 unused pi-gippity-control README 3,878 B. Install pi install npm:@howaboua/pi-gippity-control; Pi 0.84.4+ / Node 22.19+; do not install beside pi-codex-conversion. LAN default port 43120; unauthenticated by design; reportRealtimeVoicePrompt is first-party. Matches tweet extension API; not a voice-changelog dump. — evidence: "leftover22 pi-gippity-readme 3878 B. Quote: Do not install this alongside @howaboua/pi-codex-conversion." [note]
**Numbers.** —
**Recipe.** —
