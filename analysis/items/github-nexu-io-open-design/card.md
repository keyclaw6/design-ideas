# OpenDesign: local-first open-source agent design workspace
...
**Question it answers.** What local-first Claude Design alternative supports BYOK agents, DESIGN.md, and multi-format exports?
