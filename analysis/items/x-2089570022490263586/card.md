# iCraft Editor for 3D network architecture diagrams (gantFDT/icraft)
...
**Question it answers.** What tool does tom_doerr recommend for 3D network architecture diagrams with visual effects?
...
**Techniques.** —
**Tools.** —
**Links.** repo (https://github.com/gantFDT/icraft), product (https://github.com/gantFDT/icraft), https://github.com/gantFDT/icraft
**Related items.** [github-cathrynlavery-diagram-design](../github-cathrynlavery-diagram-design/card.md), [github-antvis-infographic](../github-antvis-infographic/card.md), [web-flint-chart](../web-flint-chart/card.md)
**Media.** —
