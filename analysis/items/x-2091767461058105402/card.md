# Dashboard Stack carousel studio — Instagram and LinkedIn slide generator
...
**Question it answers.** What tool generates Instagram and LinkedIn carousel slides for social distribution?
...
**Recipe.** —
**Techniques.** —
**Tools.** [dashboard-stack](../../tools/dashboard-stack.md)
**Links.** product (https://studio.dashboardstack.sh)
