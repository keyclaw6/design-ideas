# CopilotKit aimock — single-port mock stack for LLM, MCP, and search
...
**Question it answers.** How can I mock an entire agent app's external stack locally on one port for development and tests?

**Claims.**
- `x-2087151521121419648#c1` (capability, stated) aimock exposes the full agent stack on one package and one port. — evidence: "That's the full stack. One package. One port." [post]
- `x-2087151521121419648#c2` (recipe, stated) Install is a single npm package command. — evidence: "`npm i @copilotkit/aimock`" [post]
**Numbers.** —
**Recipe.** —
**Techniques.** —
**Tools.** [copilotkit-aimock](../../tools/copilotkit-aimock.md)
