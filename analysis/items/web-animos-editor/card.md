# animos browser editor: 25 motion templates export MP4 or WebM

`web-animos-editor` · website · product · en · [source](https://animos.app/editor) · [raw](../../../raw/items/web-animos-editor/)
**Author:** animos (@—) · **Published:** — · **Captured:** 2026-09-02T17:15:19Z
**Disposition:** analyze · **Readiness:** ready · **Gaps:** —
**Subject:** [code-motion-graphics](../../subjects/code-motion-graphics/brief.md) · **Also:** [landing-ui-motion](../../subjects/landing-ui-motion/brief.md) · **Roles:** tool, example · **Platforms:** browser, react

**Summary.** animos.app/editor is a React/Vite SPA with 25 ready-made motion templates for design showcases. Drop in images or video, tweak in browser, and export MP4 or WebM locally without After Effects or custom code.
**Question it answers.** How can I export a short design-showcase motion clip in the browser without After Effects?
