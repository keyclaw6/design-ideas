# npaka note on when to drive Blender via CLI versus MCP
...
**Question it answers.** When should an agent use Blender CLI versus MCP to control Blender?
...
**Techniques.** —
**Tools.** —
**Links.** https://note.com/npaka/n/n7f7531e7b9ed
**Related items.** —
**Media.** —
