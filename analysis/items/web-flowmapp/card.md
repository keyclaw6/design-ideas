# Flowmapp — agency sitemap, wireframe, and estimate platform

`web-flowmapp` · website · product · en · [source](https://www.flowmapp.com/) · [raw](../../../raw/items/web-flowmapp/)
**Author:** Flowmapp (@Flowmapp) · **Published:** — · **Captured:** 2026-09-02T20:15:00Z
...
**Summary.** SaaS website-planning platform for agencies covering briefs, interactive sitemaps, AI-generated wireframes, content, user flows, cost estimates, invoices, and client presentation exports to Figma or PDF.
**Question it answers.** What tool scopes marketing-site IA and client estimates before visual design or agent codegen?
