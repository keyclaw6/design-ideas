# beautifului.dev AI-native UI component kit for agent apps
...
**Question it answers.** What off-the-shelf UI kit covers streaming, approvals, and diff surfaces for agent consoles?
...
**Techniques.** —
**Tools.** —
**Links.** product (https://beautifului.dev)
