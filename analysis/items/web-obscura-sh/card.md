...
- `web-obscura-sh#c3` (availability, demonstrated) leftover30 unused github.com/h4ckf0r0day/obscura and docs.obscura.sh / llms.txt host strings are leftover24/27. No new integers. — evidence: "leftover30-2026-09-05.json skip obscura leftover24/27." [note]
**Numbers.** —
**Recipe.** —
**Techniques.** [agent-browser-isolation](../../techniques/agent-browser-isolation.md)
**Tools.** [obscura](../../tools/obscura.md)
**Links.** repo (https://github.com/h4ckf0r0day/obscura), https://docs.obscura.sh, https://docs.obscura.sh/llms.txt, https://github.com/h4ckf0r0day/obscura
