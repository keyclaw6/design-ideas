# Community ranked top 10 anti-slop writing skills on skills.sh

`x-2090834948332655011` · x · thread · en · [source](https://x.com/juampitech/status/2090834948332655011) · [raw](../../../raw/items/x-2090834948332655011/)
**Author:** juampitech (@juampitech) · **Published:** — · **Captured:** 2026-09-04T07:52:36Z
**Disposition:** analyze · **Readiness:** ready-with-gaps · **Gaps:** —
**Subject:** [design-agent-skills](../../subjects/design-agent-skills/brief.md) · **Also:** — · **Roles:** reference · **Platforms:** cursor, claude-code

**Summary.** Curated X thread ranking ten installable anti-slop skills—stop-slop, no-ai-slop, humanizer variants, unslop, deslop, and anti-ai-slop-writing—with direct skills.sh links as a shopping list for prose humanizers.
**Question it answers.** Which community anti-slop writing skills should I install from skills.sh?
