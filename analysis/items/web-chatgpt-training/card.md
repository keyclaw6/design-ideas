# OpenAI ChatGPT Training: Work/Codex labs and plugins-vs-skills walkthroughs

`web-chatgpt-training` · website · course · en · [source](https://learn.chatgpt.com/training) · [raw](../../../raw/items/web-chatgpt-training/)
**Author:** OpenAI (@—) · **Published:** — · **Captured:** 2026-09-02T20:38:00Z
**Disposition:** analyze · **Readiness:** ready · **Gaps:** —
**Subject:** [agent-harness-loops](../../subjects/agent-harness-loops/brief.md) · **Also:** — · **Roles:** reference, technique · **Platforms:** codex, browser

**Summary.** Official learn.chatgpt.com/training hub with hands-on Work and Codex labs plus six walkthroughs covering plugins vs skills, scheduled tasks, browser use, and llms.txt machine-readable doc exports.
**Question it answers.** Where does OpenAI document the difference between ChatGPT plugins and skills for Work and Codex?
