# Mint Studio browser 3D camera control for video generation
...
**Question it answers.** What browser tool provides 3D camera control for video generation without Blender?
...
**Recipe.** —
**Techniques.** —
**Tools.** [mint-studio](../../tools/mint-studio.md)
**Links.** —
**Related items.** —
**Media.** —
