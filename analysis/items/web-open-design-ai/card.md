# OpenDesign product site — local vibe-design workspace for 21+ agents

`web-open-design-ai` · website · product · en · [source](https://open-design.ai) · [raw](../../../raw/items/web-open-design-ai/)
**Author:** nexu-io (@nexu-io) · **Published:** — · **Captured:** 2026-09-02T17:42:00Z
**Disposition:** analyze · **Readiness:** ready · **Gaps:** —
**Subject:** [design-agent-skills](../../subjects/design-agent-skills/brief.md) · **Also:** — · **Roles:** tool, example · **Platforms:** codex, cursor, claude-code

**Summary.** Marketing site for OpenDesign, an Apache-2.0 local-first vibe design workspace that routes 21+ coding agents through composable skills and portable DESIGN.md files. Contrasts with hosted Claude Design by keeping prototypes, landings, slides, and brand artifacts as repo files with BYOK.
**Question it answers.** What is OpenDesign and how does its local file-based vibe design workspace differ from hosted Claude Design?
