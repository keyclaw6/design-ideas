# Thread — MiniMax H3 Max video model on Magnific tuned by fal (x-2091924963288580539)

**Status:** captured_full · **Author thread:** none · **Replies reported:** 2 · **Captured:** 2 · **Relevant:** 1 · **Unfetched:** 0 · **Truncated:** False
**Fetch log:** x-web-dom→ok (2026-09-04T17:54:20Z); fxtwitter-api→ok (2026-09-04T17:54:20Z)
**Raw payloads:** `raw/items/x-2091924963288580539/thread-raw/x-web-dom-20260904T175320Z.html`
...
> @magnific @fal where is it? i just signed up to try it and don't see it in the drop downs
