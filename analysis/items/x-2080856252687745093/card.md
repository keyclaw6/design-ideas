...
**Summary.** X thread promoting autoresearch.aman.ai, a primer on autonomous research loops and Meta-Harness optimization. Covers propose-run-evaluate cycles, filesystem experiment memory, and harness search beyond model weights.
...
**Techniques.** —
**Tools.** —
**Links.** product (https://autoresearch.aman.ai)
