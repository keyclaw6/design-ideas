...
**Tools.** —
**Links.** repo (https://github.com/karpathy/autoresearch), product (https://aman.ai/primers/ai/autoresearch-and-metaharness/), https://aman.ai/primers/ai/autoresearch-and-metaharness/, https://aman.ai/
