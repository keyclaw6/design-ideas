# MiniMax 3D Director Stage: block scenes before H3 generation
...
**Question it answers.** When should I use MiniMax 3D Director Stage instead of fighting H3 for exact camera-frame matching?
