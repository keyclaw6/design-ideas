...
- `github-h4ckf0r0day-obscura#c7` (capability, demonstrated) leftover27 unused docs.obscura.sh/llms.txt 2,687 B lists 21 documentation links plus a GitBook ?ask= query endpoint. leftover27 does not run that ask endpoint or time the leftover24 Star 16.2k / <50ms / 10× claims. — evidence: "leftover27 obscura-llms 2687 B. 21 doc links + GitBook ?ask=." [note]
