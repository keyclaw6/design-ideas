# Shubhamsaboo awesome-llm-apps catalog (~132k stars)
...
**Question it answers.** Where can I browse example LLM app implementations when no domain-specific item exists yet?
