# LightFuse: relightable multi-scan Gaussian reconstruction with 2DGS ray tracing

`x-2094769581965369822` · x · paper · en · [source](https://x.com/janusch_patas/status/2094769581965369822) · [raw](../../../raw/items/x-2094769581965369822/)
**Author:** MrNeRF (@janusch_patas) · **Published:** — · **Captured:** 2026-09-04T06:50:07Z
**Disposition:** analyze · **Readiness:** ready-with-gaps · **Gaps:** —
**Subject:** [gaussian-splatting](../../subjects/gaussian-splatting/brief.md) · **Also:** — · **Roles:** reference, claim-source · **Platforms:** —

**Summary.** MrNeRF presents LightFuse for relightable multi-scan interactive Gaussian reconstruction with material–illumination decomposition, reporting +9.74 dB PSNR and +0.121 SSIM over the strongest baseline on synthetic scenes.
**Question it answers.** How does LightFuse achieve relightable multi-scan Gaussian scene reconstruction?
