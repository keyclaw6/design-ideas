# iannuttall/seo CLI and MCP for local SEO audits

`github-iannuttall-seo` · github · repo · en · [source](https://github.com/iannuttall/seo) · [raw](../../../raw/items/github-iannuttall-seo/)
**Author:** Ian Nuttall (@iannuttall) · **Published:** — · **Captured:** 2026-09-02T17:57:00Z
**Disposition:** analyze · **Readiness:** ready · **Gaps:** —
**Subject:** [serp-ai-visibility](../../subjects/serp-ai-visibility/brief.md) · **Also:** [mcp-and-agent-browsers](../../subjects/mcp-and-agent-browsers/brief.md) · **Roles:** tool, reference · **Platforms:** mcp, cli

**Summary.** Apache-licensed npm CLI (seoskill.dev) that runs technical SEO audits, Search Console and GA4 reports, competitor research, and IndexNow submission from your machine, with MCP install for Cursor and CI-friendly JSON exports.
**Question it answers.** How do I run agent-accessible SEO audits on my own crawl and Google data?
