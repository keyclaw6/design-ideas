...
- `x-2094524951025914278#c6` (availability, demonstrated) leftover23 unused dicebear.com 127,824 B. Title DiceBear | Open Source Avatar Library & API. First-party: 61 styles; Star 9.5k; MIT core; HTTP API + JS/PHP/Python/Rust/Go/Dart/C#/CLI; 1B API requests / month. Matches the tweet’s scroll-drawn Dicebear vine as a real avatar library, not a design-system gallery. — evidence: "leftover23 dicebear 127824 B. Quote: 61 avatar styles." [note]
- `x-2094524951025914278#c7` (availability, demonstrated) leftover25 unused blume.codes 248,749 B is Blume Sidecar — Monitor and Improve Coding Agents (leftover19 homepage was 253,619 B). First-party: local history; Cursor / Claude Code / Codex / Pi; Usage / Setup / Agents / Improve. This is the sidecar product, not a design-system gallery. Dicebear leftover stays on #c6. — evidence: "leftover25 blume-codes 248749 B. Title Blume Sidecar — Monitor and Improve Coding Agents." [note]
...
**Links.** product (https://blume.codes), https://www.dicebear.com, https://fal.ai, https://blume.codes
