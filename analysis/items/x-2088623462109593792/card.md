# PipesHub OSS governed context layer for enterprise RAG and agents

`x-2088623462109593792` · x · repo · en · [source](https://x.com/tom_doerr/status/2088623462109593792) · [raw](../../../raw/items/x-2088623462109593792/)
**Author:** Tom Doerr (@tom_doerr) · **Published:** — · **Captured:** 2026-09-04T06:52:23Z
**Disposition:** analyze · **Readiness:** ready · **Gaps:** —
**Subject:** [agent-memory-knowledge](../../subjects/agent-memory-knowledge/brief.md) · **Also:** — · **Roles:** tool, reference · **Platforms:** mcp

**Summary.** Tom Doerr points to PipesHub (pipeshub-ai), an open-source governed context layer connecting enterprise knowledge for agents, RAG apps, and search with permissions and audit instead of per-app silos.
**Question it answers.** What OSS stack offers a governed enterprise knowledge plane for agents and RAG?
