# Arcana Splat2Mesh launch: 3DGS PLY to OBJ/GLB (Japanese)

`x-2094648474377839018` · x · announcement · ja · [source](https://x.com/ArcanaMfg/status/2094648474377839018) · [raw](../../../raw/items/x-2094648474377839018/)
**Author:** Arcana Mfg.Co.,Ltd. | 株式会社Arcana製作所 (@@ArcanaMfg) · **Published:** 2026-09-01T04:48:07Z · **Captured:** 2026-09-02T18:33:15Z
**Disposition:** analyze · **Readiness:** ready · **Gaps:** —
**Subject:** [gaussian-splatting](../../subjects/gaussian-splatting/brief.md) · **Also:** — · **Roles:** claim-source, tool · **Platforms:** other

**Summary.** Arcana Mfg announces Splat2Mesh v1.0 converting 3D Gaussian Splatting PLY files to OBJ/GLB locally with free personal non-commercial use. Launch tweet quotes a teaser video showing the v1.0 UI loading MipNeRF360 bicycle.ply.
**Question it answers.** What does Arcana Splat2Mesh convert and what license terms apply at launch?
