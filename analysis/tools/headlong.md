...
Local clone 2026-09-04 (`wc -l`, not cloc): `bin/` **12,133** lines (named tools: `chat` 662, `context` 581, `llm` 1500, `mem` 570, `recap` 820, `shellm` 3176, `shellm-docker` 215, `skills` 613, `thinkers` 1811, `traj` 2185) + `thinkers/` **1,814** = **13,947** excluding READMEs. Do not collapse `wc` 13,947 and README cloc ~11K / 11.5K cap.
