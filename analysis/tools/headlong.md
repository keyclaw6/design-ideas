...
**2026-09-05 leftover22.** Unused Laude post `https://www.laude.org/updates/headlong-a-microharness-for-persistent-agents` **200 / 227,836 B**. Body still says **<10K / 9.9K** in `bin/` + `thinkers/` — do not collapse with cloc **9,912** or `wc` **13,947**. `headlong.ai/install.sh` **25,935 B** clones `laude-institute/headlong` to `~/.headlong/app`; BIN_TOOLS 10 + AUX_TOOLS 13. Receipt `leftover22-2026-09-05.json`.

**2026-09-05 leftover26.** Unused `laude.org` host string is leftover22 `#c4`. No new integers. Receipt `leftover26-2026-09-05.json`.
<!-- NOTES:END -->
