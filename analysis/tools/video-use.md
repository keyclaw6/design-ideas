...
**2026-09-05 capture — GitHub API.** `browser-use/video-use` MIT, **24,025** stars. Root: `SKILL.md`, `helpers/`, `skills/`, `tests/`. Receipt `analysis/_work/captures/leftover-2026-09-05.json`.
<!-- NOTES:END -->
