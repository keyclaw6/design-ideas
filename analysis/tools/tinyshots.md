...
**Slug:** `tinyshots` · **Kind:** product · **URL:** https://tinyshots.app · **Canonical item:** [web-tinyshots](../items/web-tinyshots/card.md)
**Subjects:** [landing-ui-motion](../subjects/landing-ui-motion/brief.md)
**Referenced by (1):**
- [TinyShots macOS screenshot polish app with agent-facing CLI](../items/web-tinyshots/card.md) — tool — landing-ui-motion

<!-- NOTES:START -->
Fetched 2026-09-05 `https://www.tinyshots.app/` GET 200 / **70,112 B**. Title TinyShots | Capture. Polish. Done. First-party: macOS screenshot polish; **$39** early-bird, **97** spots left, then **$49**; one-time; fully offline; macOS Sonoma 14+. No Ahrefs/Moz DR integer.
