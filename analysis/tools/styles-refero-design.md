...
**2026-09-05 re-count.** Same walk, key is now `styles` (not `items`). Pages 1–64 = 20, page 65 = 10, page 66 empty `{"styles":[],"nextCursor":null,"nextPage":null}`. Totals still **1,289 / 1,241**. Receipt `analysis/_work/captures/2026-09-05-refero-recount.json`.
