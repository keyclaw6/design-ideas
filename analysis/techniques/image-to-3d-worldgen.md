...
**2026-09-05 leftover28.** Unused `seed.bytedance.com/en/seed3d_2_0` **136,088 B** is the Seed model hub (Seedance 2.5 / Seedream 5.0 Pro / …). Visible extract does **not** name Seed3D 2.0 or Lucida. No user export. Receipt `leftover28-2026-09-05.json`.
<!-- NOTES:END -->
