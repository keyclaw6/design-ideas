...
LightFuse (card `x-2094769581965369822`, thread still `failed`): paper is Zhou et al. 2026, arXiv:2608.29269. Real project page is **https://zhn202.github.io/LightFuse/** (`lightfuse.github.io` 404). 2D Gaussian multi-scan fusion + ray-tracing-oriented geometry refine + staged inverse rendering (shared metallic–roughness, per-state env map, differentiable one-bounce path tracing). Claimed +9.74 dB PSNR / +0.121 SSIM vs strongest baseline on synthetic novel-state relighting. Authors ZJU-UIUC / Sichuan / ZJU / Chengdu Minto. GitHub search for a 2026 Gaussian LightFuse repo returned 0; do not confuse with the 2021 CNN HDR “LightFuse.” No weights zip on the project page.
<!-- NOTES:END -->
