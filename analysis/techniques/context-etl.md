...
**2026-09-05 leftover15 — Driscoll-linked essays (no new tool files).** `https://www.iandmacomber.com/blog/post-ai-data-stack` **200 / 67,426 B**, title *The Shape and Feel of the Post-AI Data Stack*. Visible: per-data-product `llms.txt`, Snowflake, Ramp Research harness, consensus-divergence loop. **Turbopuffer** and Da Vinci collage strings **absent**. `https://claude.com/blog/how-anthropic-enables-self-service-data-analytics-with-claude` **200 / 565,721 B**: **95%** of business analytics queries automated / **~95%** aggregate accuracy; skills lift evals above **95%**; offline accuracy drifted **~95% → ~65%**. `https://www.cerebras.ai/blog/how-we-built-our-knowledge-base` this pass **HTTP 500 / 348,376 B** (title present, visible **0**) — do not retry. Driscoll leftover is an amplify collage, not those bodies ([x-2094558408259272998](../items/x-2094558408259272998/card.md)). Receipt `leftover15-2026-09-05.json`.
<!-- NOTES:END -->
