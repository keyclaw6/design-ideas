#!/usr/bin/env python3
"""leftover18: LinkedIn leftover t.co + Corey Haines first-party. No 429 hammer."""
...
OUT = Path("/workspace/analysis/_work/captures/leftover18-2026-09-05")
...
URLS = {
    "tco-linkedin-quoted": "https://t.co/sHIeqAYMPB",
    "tco-linkedin-reply": "https://t.co/NODoPwKhsE",
    "corey-com": "https://coreyhaines.com/",
    "corey-co": "https://coreyhaines.co/",
    "conversionalchemy": "https://www.conversionalchemy.com/",
    "gh-coreyhainesco": "https://api.github.com/users/coreyhainesco",
    "known-agency": "https://www.known.agency/",
}
...
def main() -> None:
    ...
    for slug, url in URLS.items():
        ...
        time.sleep(0.4)
    path = Path("/workspace/analysis/_work/captures/leftover18-2026-09-05.json")
    path.write_text(json.dumps({"fetched_at": "2026-09-05T08:10:00Z", "pages": pages}, indent=2), encoding="utf-8")
    print("wrote", path)
