#!/usr/bin/env python3
"""leftover29: remaining unused READY-card first-party. No 429 hammer."""
...
OUT = Path("/workspace/analysis/_work/captures/leftover29-2026-09-05")
...
def main() -> None:
    ...
    for slug, url in URLS.items():
        ...
        time.sleep(0.4)
    path = Path("/workspace/analysis/_work/captures/leftover29-2026-09-05.json")
    path.write_text(
        json.dumps({"fetched_at": "2026-09-05T15:00:00Z", "pages": pages}, indent=2),
        encoding="utf-8",
    )
    print("wrote", path)
