#!/usr/bin/env python3
"""leftover23: leftover unused arXiv abs + product pages. No 429 hammer."""
...
OUT = Path("/workspace/analysis/_work/captures/leftover23-2026-09-05")
...
URLS = {
    "freetoken-abs": "https://arxiv.org/abs/2608.16157",
    "gbrain-abs": "https://arxiv.org/abs/2604.21284",
    "treg-abs": "https://arxiv.org/abs/2603.27476",
    "dicebear": "https://www.dicebear.com",
    "cal-graphed": "https://cal.com/team/graphed-com/discovery",
    "npm-seo": "https://www.npmjs.com/package/seo",
    "component-gallery": "https://component.gallery/",
    "orbs": "https://orbs.jakubantalik.com/",
    "transitions-dev": "https://transitions.dev/",
    "twentyfirst": "https://21st.dev/",
...
def main() -> None:
    ...
    for slug, url in URLS.items():
        ...
        time.sleep(0.4)
    path = Path("/workspace/analysis/_work/captures/leftover23-2026-09-05.json")
    path.write_text(
        json.dumps({"fetched_at": "2026-09-05T10:10:00Z", "pages": pages}, indent=2),
        encoding="utf-8",
    )
    print("wrote", path)
