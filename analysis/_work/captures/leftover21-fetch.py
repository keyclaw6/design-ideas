#!/usr/bin/env python3
"""leftover21: Slite remaining names + FreeToken/OpenViking/gbrain-evals. No 429 hammer."""
...
OUT = Path("/workspace/analysis/_work/captures/leftover21-2026-09-05")
...
URLS = {
    "gh-gbrain-evals": "https://api.github.com/repos/garrytan/gbrain-evals",
    "gbrain-evals-readme": "https://raw.githubusercontent.com/garrytan/gbrain-evals/main/README.md",
    "flashml": "https://flashml.ai/",
    "freetoken-readme": "https://raw.githubusercontent.com/FlashML-org/FreeToken/main/README.md",
    "gh-freetoken": "https://api.github.com/repos/FlashML-org/FreeToken",
    "ov-readme": "https://raw.githubusercontent.com/volcengine/OpenViking/main/README.md",
    "ov-llms": "https://docs.openviking.ai/llms.txt",
    "slite-agent": "https://slite.com/slite-agent",
    "slite-agent-help": "https://slite.com/help/TvEOZjLtSgTmA8/Slite-AI-Agent",
    "gh-sylph": "https://api.github.com/repos/getnao/sylph",
    "sylph-readme": "https://raw.githubusercontent.com/getnao/sylph/main/README.md",
    "pletor-home": "https://www.pletor.ai/",
    "pletor-brain": "https://www.pletor.ai/blog/meet-brain-persistent-brand-memory-for-ai-creative-production",
    "impeccable-410": "https://api.github.com/repos/pbakaus/impeccable/releases/tags/skill-v4.1.0",
    "tco-gsc": "https://t.co/PoWaCmXdsQ",
    "tco-goji": "https://t.co/s0za9kxTZC",
}
...
def main() -> None:
    ...
    for slug, url in URLS.items():
        ...
        time.sleep(0.4)
    path = Path("/workspace/analysis/_work/captures/leftover21-2026-09-05.json")
    path.write_text(
        json.dumps({"fetched_at": "2026-09-05T08:50:00Z", "pages": pages}, indent=2),
        encoding="utf-8",
    )
    print("wrote", path)
